...
namespace SistemaCitasMedicas.Controllers
{
    public class EmpleadosController : Controller
    {
        ...
        {
            List<String> items = new List<String> { "Doctor", "Secretaria", "Enfermera", "Camillero" };
            ViewData["Roles"] = new SelectList(items);
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Rol,Activo,Correo")] Empleado empleado)
        {
            if (id != empleado.Id)
            {
                return NotFound();
